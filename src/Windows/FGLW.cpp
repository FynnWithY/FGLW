...
//
	...
	int index = ChoosePixelFormat(m_hdc, &pixelFormat);
	PIXELFORMATDESCRIPTOR supportedPixelFormat;
	DescribePixelFormat(m_hdc, index, sizeof(PIXELFORMATDESCRIPTOR), &supportedPixelFormat);
	SetPixelFormat(m_hdc, index, &supportedPixelFormat);
