...
template<> Color Material<MAT_AIR>::color=0xFF111111;
template<> MaterialType Material<MAT_AIR>::type=MAT_AIR;

template<> Color Material<MAT_SAND>::color=0xFF47c6d1;
template<> MaterialType Material<MAT_SAND>::type=MAT_SAND;
template<> void Material<MAT_SAND>::Update(MaterialType *map, int x, int y)
{
